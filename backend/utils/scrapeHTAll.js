...
//     const news = [];
//     $('.cartHolder, .listingPage .media, .mainStory').each((i, el) => {
...
//     return news;
//   } catch (err) {
//     console.error('Error scraping Hindustan Times All News:', err.message);
//     return [];
//   }
// }

// module.exports = scrapeHTAll; 